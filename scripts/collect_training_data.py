...
from breakout_vhal.data_logger import TrainingDataLogger
from breakout_vhal.game import BreakoutGame, ControlMode, PlayState
...
def main() -> None:
    ...
    game.control_mode = ControlMode.MATHEMATICAL_AGENT
    game._launch_ball()
